...
def main():
    ...
    hitTxt = font.render('PEDIR', 1, black)
    standTxt = font.render('FICAR', 1, black)
    restartTxt = font.render('Reniciar', 1, black)
    gameoverTxt = font.render('O JOGO ACABOU', 1, white)
    winner = font.render('voce ganhou', 1, white)
    ...
    hitB = pygame.draw.rect(background, gray, (10, 445, 80, 25))
    standB = pygame.draw.rect(background, gray, (95, 445, 80, 25))
    ratioB = pygame.draw.rect(background, gray, (555, 420, 100, 50))
    ...
    while True:
        ...
        #check if game is winner
        
    
           

        #background needs to be redisplayed because it gets updated
        winTxt = font.render('Vitorias: %i' % winNum, 1, black)
        ...
        screen.blit(hitTxt, (20, 448))
        screen.blit(standTxt, (105, 448))
        screen.blit(winTxt, (560, 423))
        screen.blit(loseTxt, (560, 448))
        ...
        if gameover or stand:
            ...
            screen.blit(restartTxt, (280, 228))
